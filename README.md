...
PyCFAST requires **Python 3.10 or later**. It is fully [tested on verification input files](https://github.com/bewygs/pycfast/tree/main/tests/verification_tests) from CFAST version **7.7.0** to version **7.7.6**. Versions below **7.7.0** might work but are not guaranteed to be fully compatible.
